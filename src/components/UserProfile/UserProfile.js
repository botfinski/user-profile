...
const userProfile = props => {
  const imgName = "data/images/" + props.user.name.replace(/\s/g, "").toLowerCase() + props.user.id;

  return (
    <div className="User-Profile">
      <div className="User-Info">
        <button type="button" className="Share-Button" onClick={props.shareClicked}>
          Share
          <svg
          ...
          >
            <g>
              <path
                fill="#FFA640"
                d="M392.9 292.4h-18.3a8.8 8.8 0 0 0-9.2 9V393A44 44 0 0 1 352 425a44 44 0 0 1-32.2 13.4H82.2A44 44 0 0 1 50 425.1 44 44 0 0 1 36.5 393V155.3A44 44 0 0 1 50 123.1a44 44 0 0 1 32.2-13.5h201c2.7 0 4.9-.8 6.6-2.5a8.9 8.9 0 0 0 2.6-6.6V82.2a8.9 8.9 0 0 0-9.1-9.1h-201c-22.7 0-42 8-58.2 24.1A79.2 79.2 0 0 0 0 155.3V393c0 22.6 8 42 24.1 58 16.1 16.1 35.5 24.2 58.1 24.2h237.6c22.6 0 42-8 58-24.1 16.2-16.1 24.2-35.5 24.2-58.1v-91.4a8.9 8.9 0 0 0-9.1-9.1z"
              />
              <path
                fill="#FFA640"
                d="M506.2 42c-3.6-3.6-8-5.5-12.9-5.5H347.2c-5 0-9.3 1.9-12.9 5.5-3.6 3.6-5.4 7.9-5.4 12.8s1.8 9.3 5.4 12.9l50.3 50.2-186.2 186.2a9 9 0 0 0 0 13.1l32.6 32.5a9 9 0 0 0 13.1 0l186.2-186.1 50.2 50.2c3.6 3.7 7.9 5.5 12.9 5.5s9.2-1.8 12.8-5.5c3.6-3.6 5.4-7.9 5.4-12.8V54.8c0-5-1.8-9.2-5.4-12.8z"
              />
            </g>
          </svg>
        </button>
        ...
        <div className="User-Info-Personal">
          ...
          <p className="User-Name">
            {props.user.name}
            <button
              className={props.liked ? "Like-Button Liked" : "Like-Button"}
              type="button"
        ...
        <div className="User-Info-Social">
          ...
          <button
            className={props.following ? "Follow-Button Following" : "Follow-Button"}
            type="button"
