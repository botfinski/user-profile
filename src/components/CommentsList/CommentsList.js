  ...
  render() {
    return (
      <div className="Comments-List-Container">
        <button className="Comments-Toggle-Button" onClick={this.props.toggleComments}>
          {this.props.hidden ? "Show comments" : "Hide comments"} ({this.props.comments.length})
        </button>
        <div ref={this.commentsListRef} className={"Comments-List" + (this.props.hidden ? " hidden" : "")}>
          <ul>
